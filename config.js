...
module.exports = {
  ...
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '❤️,GEE',
  ...
  ANTILINK_MSG: process.env.ANTILINK_MSG || '_Antilink Detected &mention kicked for sending nonesence_',
  ANTISPAM_MSG: process.env.ANTISPAM_MSG || '_Antispam Detected &mention kicked for stupidity_',
  ANTIWORDS_MSG: process.env.ANTIWORDS_MSG || '_AntiWord Detected &mention kicked very fast here_',
  ...
  ANTI_BOT_MESSAGE: process.env.ANTI_BOT_MESSAGE || '&mention removed aende uko mbali',
  WARN_MESSAGE:
    process.env.WARN_MESSAGE ||
    '⚠️WARNING⚠️\n*User :* &mention\n*Warn :* &warn\n*Remaining :* &remaining',
  WARN_RESET_MESSAGE:
    process.env.WARN_RESET_MESSAGE || `WARN RESET\nUser : &mention\nRemaining or you get the f*ck out: &remaining`,
  WARN_KICK_MESSAGE: process.env.WARN_KICK_MESSAGE || '&mention kicked with no mercy',
